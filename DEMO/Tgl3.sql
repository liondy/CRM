CREATE PROCEDURE Tgl3
AS
    EXEC inverstasiUpdate 'Ipin', 'rancabulan', '19951020', 'cimahi', 200000, 1
    ...
    EXEC inverstasiUpdate 'Rose', 'cemara', '19701210', 'bandung', 500000, 2
    ...
    EXEC inverstasiUpdate 'Jarjit', 'cemara', '19951217', 'Bandung', 350000, 3
