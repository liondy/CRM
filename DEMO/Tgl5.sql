...
AS
	...
	UPDATE investasi SET waktu = '20200105 01:12:00 PM' WHERE fkIdKlien = 10
	UPDATE perubahan SET waktu = '20200105 01:12:00 PM' WHERE idRecord=10 AND tabel = 'hubungan' AND operasi = 'INSERT'
	UPDATE perubahan SET waktu = '20200105 01:12:00 PM' WHERE idRecord=10 AND tabel = 'investasi' AND operasi = 'INSERT'
	UPDATE perubahan SET waktu = '20200105 01:12:00 PM' WHERE idRecord=10 AND tabel = 'klien' AND operasi = 'INSERT'

	EXEC investasiUpdate 'Udin','cemara','19680602','Bandung',500000,1
	UPDATE investasi SET waktu ='20200105 1:45:00 PM' WHERE fkIdKlien=1
	UPDATE perubahan SET waktu ='20200105 1:45:00 PM' WHERE idRecord=1 AND tabel='investasi' AND operasi ='UPDATE'
GO